...
//   return (
//     <div className="w-[300px] h-[200px] bg-[#f0f0f9] bg-opacity-80 relative grid place-content-center rounded-lg overflow-hidden transition-all duration-500 ease-in-out hover:rounded-none hover:scale-110">
//       {/* Border */}
//       <div className="absolute inset-0 border-2 border-[#bd9f67] opacity-0 rotate-[10deg] transition-all duration-500 ease-in-out hover:inset-[15px] hover:opacity-100 hover:rotate-0"></div>
...
//             <p className="text-xl text-[#bd9f67] uppercase">{type}</p>
//             <p className="text-lg text-[#243137] font-semibold">{name}</p>
//           </div>
//         </div>

//         {/* Logo Section */}
//         {/* <div className="h-[35px] relative w-[33px] overflow-hidden transition-all duration-1000 ease-in-out hover:w-[134px]">
...
//           </svg>
//         </div>
//         <span className="absolute right-0 h-full w-full opacity-0 hover:opacity-100 hover:animate-trail"></span>
//       </div> */}

//         {/* Logo Bottom Text */}
//         {/* <span className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-[30px] text-[#bd9f67] pl-[8px] text-[11px] opacity-0 transition-all duration-500 ease-in-out delay-500 hover:opacity-100 hover:tracking-[9.5px]">
//         uiverse.io
//       </span> */}
//       </div>

//       {/* Bottom Text */}
//       {/* <span className="absolute left-1/2 bottom-[13px] transform -translate-x-1/2 text-[6px] uppercase px-[5px] py-0 text-[#bd9f67] bg-[#243137] bg-opacity-80 opacity-0 tracking-[7px] transition-all duration-500 ease-in-out hover:opacity-100 hover:tracking-[3px]">
//       universe of ui
//     </span> */}
//     </div>
//   );
