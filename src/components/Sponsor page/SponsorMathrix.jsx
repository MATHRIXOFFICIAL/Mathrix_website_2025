...
const SponsorMathrix = () => {
  ...
  return (
    <div className="min-h-screen p-10 bg-[#00FFF0]">
      <div className="flex flex-col gap-5 justify-center items-center py-10">
        <p className="text-4xl font-extrabold text-red-500">Our Sponsors</p>
        <p className="text-neutral-600 text-xl">
          We are proud to present our incredible lineup of sponsors!
        </p>
        <div className="mt-5 flex gap-5">
          {/* <div className="w-[300px] h-[200px] bg-[#243137] relative grid place-content-center rounded-lg overflow-hidden transition-all duration-500 ease-in-out hover:rounded-none hover:scale-110">
            ...
            <span className="absolute left-1/2 bottom-[13px] transform -translate-x-1/2 text-[6px] uppercase px-[5px] py-0 text-[#bd9f67] bg-[#243137] opacity-0 tracking-[7px] transition-all duration-500 ease-in-out hover:opacity-100 hover:tracking-[3px]">
              universe of ui
            </span>
          </div> */}
